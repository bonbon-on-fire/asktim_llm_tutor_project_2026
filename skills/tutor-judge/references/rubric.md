...
- Cap total deduction for 1.3 at 6 points.
...
- Cap total deduction for 2.2 at 8 points.
...
#### 3.1.A Response length control (Remove 4 points if any one is triggered)
...
#### 3.1.B Language simplicity and precision (Remove 2 point if any one is triggered)
- 3.1.B.a Tutor uses avoidable dense language, for example:
...
- 3.2.B.b Tutor does not clarify formative framing when giving evaluative feedback, for example:
...
- Cap total deduction for 3.2 at 4 points.
...
| 3. Communication quality |    3.1-3.2   |         10 |
| **Base total**           |              |     **46** |
