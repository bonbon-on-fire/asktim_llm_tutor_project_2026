...
│   ├── cooperative_raw/              # Raw transcripts — standard pipeline
│   ├── cooperative_claude/           # Claude-graded copies of cooperative_raw/
│   ├── cooperative_raw_tutor_05/     # Raw transcripts generated with tutor_05
│   └── cooperative_claude_tutor_05/  # Claude-graded copies of cooperative_raw_tutor_05/
...
- **`{persona}_gpt/`** — Copies of raw transcripts with a `grade` object added by the GPT judge (`judge/run_judge.py`, provider=`gpt`).
