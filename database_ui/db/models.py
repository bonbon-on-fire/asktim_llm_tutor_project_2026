"""Minimal read-only SQLAlchemy models for database_ui.
...
is owned by the live apps (``main_ui`` / ``sandbox_ui``); we only SELECT.
"""
...
class Base(DeclarativeBase):
    """Declarative base for database_ui's read-only models."""
