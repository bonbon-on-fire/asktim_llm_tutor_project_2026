"""Claude single-transcript judge wrapper (unified core)."""
...
judge_transcript = judge_transcript_claude
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python judge/run_judge_claude.py <transcript_name>")
        print("Example: python judge/run_judge_claude.py chaotic/chaotic_raw/transcript_01")
        raise SystemExit(0)
