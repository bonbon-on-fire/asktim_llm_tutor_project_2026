...
#### 1.3.C Fails to prompt reflection after success following failure (Remove 2 point if any one is triggered)
...
- 3.1.A.b Tutor uses avoidable dense language, for example:
  - Simpler phrasing would preserve meaning and improve comprehension.

- Cap total deduction for 3.1 at 4 points.
